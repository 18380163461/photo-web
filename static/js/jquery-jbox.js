...
(function (a) {
  a.jBox = function (b, c) {
    ...
    if (g) {
      j.push('<div class="jbox-title-panel" style="height:36px;">');
    ...
    a.each(b, function (N, O) {
      ...
      r.push('<div class="jbox-button-panel" style="height:33px;padding:5px 0 5px 0;text-align: right;' + (P ? '' : 'display:none;') + '">');
      if (!c.isTip) {
